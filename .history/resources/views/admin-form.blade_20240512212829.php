...
<div class="container mt-4">
  ...
  <div class="card">
    ...
    <div class="checkbox-inline">
        <input type="checkbox" id="max_value" name="max" value="1" class="@error('max') is-invalid @enderror">
        <label for="Max">Max</label>
        <input type="number" name="quantity" min="1" class="@error('max') is-invalid @enderror">
    </div>
    <div class="checkbox-inline">
