    ...
    @else
          ...
          <div class="form-group">
            ...
            <input type="text" id="name" placeholder="{{ $item->field_label }}"
              ...
              class="@error("{{ strtolower(str_replace(' ', '_', $item->field_name)) }}") is-invalid @enderror form-control">
            @error("{{ strtolower(str_replace(' ', '_', $item->field_name)) }}")
        <div class="alert alert-danger mt-1 mb-1">"{{ strtolower(str_replace(' ', '_', $item->field_name)) }}"</div>
      @enderror
          </div>
