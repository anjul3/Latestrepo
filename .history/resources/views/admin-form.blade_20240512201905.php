...
<div class="container mt-4">
  ...
  <div class="card">
    ...
    <div class="checkbox-inline">
        <input type="checkbox" id="min" name="min[]" value="" class="@error('age') is-invalid @enderror">
        <label for="age_18">Min</label>
    </div>
    <div class="checkbox-inline">
        <input type="checkbox" id="max" name="max[]" value="" class="@error('age') is-invalid @enderror">
        <label for="age_19">Max</label>
    </div>
    <div class="checkbox-inline">
        <input type="checkbox" id="required" name="required[]" value="" class="@error('age') is-invalid @enderror">
        <label for="age_20">Required</label>
    </div>
    <div class="checkbox-inline">
        <input type="checkbox" id="email" name="email[]" value="" class="@error('age') is-invalid @enderror">
