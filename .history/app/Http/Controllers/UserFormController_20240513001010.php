...
class UserFormController extends Controller
{
    ...
    public function userStore(Request $request)
    {
        ...
        try {
            ...
            if ($existingUser) {
                return redirect('user-form')->with('status', 'User already filled form');
            }
            ...
            return redirect('user-form')->with('error', 'Form Submitted Successfully');
        } catch (Exception $e) {

            return redirect('user-form')->with('error', 'Error: ' . $e->getMessage());
        }
    }
