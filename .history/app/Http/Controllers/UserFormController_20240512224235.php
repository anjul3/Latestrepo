...
class UserFormController extends Controller
{
    ...
    public function userStore(Request $request)
    {
        ...
        $adminRules = Admin::pluck('rules', 'column_name')->toArray(); // Assuming 'column_name' is the name of the column
    
    $validationRules = [];
    foreach ($adminRules as $column => $rules) {
        // Explode the rules string into an array
        $rulesArray = explode('|', $rules);
        
        // Append each rule to the validationRules array
